...
_DEFAULT_VOICE = "en-US-Chirp3-HD-Aoede"
_DEFAULT_LANG = "en-US"
...
def run(text):
    ...
    out_path = os.path.join(out_dir, f"{base_name}_tts_female.wav")
    counter = 2
    while os.path.exists(out_path):
        out_path = os.path.join(out_dir, f"{base_name}_tts_female_{counter}.wav")
        counter += 1
